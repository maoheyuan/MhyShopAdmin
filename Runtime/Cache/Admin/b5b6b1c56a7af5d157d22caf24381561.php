...
<form class="form-horizontal mt20" enctype="multipart/form-data" method="post" action="<?php echo U('Member/add');?>">
    ...
    <div class="form-group">
        <label for="member_name" class="col-sm-2 control-label"><span aria-hidden="true">&times;</span>上级分类：</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="member_name" class="col-sm-2 control-label"><span aria-hidden="true">&times;</span>分类名称：</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input  class="form-control" id="member_mobile" name="member_mobile" placeholder="排序" >
        </div>
    </div>
