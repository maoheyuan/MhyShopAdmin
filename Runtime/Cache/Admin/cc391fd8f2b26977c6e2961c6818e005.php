...
<form class="form-horizontal mt20" enctype="multipart/form-data" method="post" action="<?php echo U('Area/update');?>">


    <div class="form-group">
        <label for="area_parent_id" class="col-sm-2 control-label">上级分类：<span aria-hidden="true">&times;</span></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="area_name" class="col-sm-2 control-label">分类名称：<span aria-hidden="true">&times;</span></label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="area_name" name="area_name" placeholder="名称" value="<?php echo ($areaInfo['area_name']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input  class="form-control" id="area_sort" name="area_sort" placeholder="排序" value="<?php echo ($areaInfo['area_sort']); ?>">
        </div>
    </div>
    <input type="hidden" name="area_id" value="<?php echo ($areaInfo['area_id']); ?>">
